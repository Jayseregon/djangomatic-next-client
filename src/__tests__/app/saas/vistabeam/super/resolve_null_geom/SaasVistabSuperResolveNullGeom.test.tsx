...
import SaasPage from "@/app/saas/vistabeam/super/resolve_null_geom/page";

// Mock next/navigation
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/vistabeam/super/resolve_null_geom",
}));
...
// Mock SaaS components with specific requirements for this page
...
describe("SaasVistabeamSuperResolveNullGeom Page", () => {
