...
import SaasPage from "@/app/saas/tds/super/clean_tbl_own/page";

// Mock next/navigation
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/super/clean_tbl_own",
}));
...
// Mock auth with complete implementation
jest.mock(
  "../../../../../../../auth",
  () => ({
    auth: jest.fn(),
...
jest.mock("@/components/saas/consoleDisplay", () => ({
  ConsoleDisplay: () => <div data-testid="console-display">Console Output</div>,
}));
...
// Update AppPageDescription mock
...
describe("SaasTdsSuperCleanTblOwn Page", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
