...
import SaasPage from "@/app/saas/tds/lld/pole_class_length_est/page";
...
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/lld/pole_class_length_est",
}));
...
describe("SaasTdsLldPoleClassEst Page", () => {
