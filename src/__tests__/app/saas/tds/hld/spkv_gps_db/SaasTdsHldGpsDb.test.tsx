...
import SaasPage from "@/app/saas/tds/hld/spkv_gps_db/page";

// Mock next/navigation
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/hld/spkv_gps_db",
}));
...
// Mock providers and other components
