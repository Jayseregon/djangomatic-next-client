...
import SaasPage from "@/app/saas/tds/admin/spkv_hp_by_split1/page";

// Mock next/navigation
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/admin/spkv_hp_by_split1",
}));
...
describe("SaasTdsAdminSpkvHpSplit Page", () => {
