...
import SaasPage from "@/app/saas/tds/super/uniq_change_tbl_own/page";

// Mock next/navigation
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/super/uniq_change_tbl_own",
}));
...
const InputDataContext = createContext(mockContextValue);
...
// Update component mocks to not use context at all
...
// Update WithPermissionOverlay mock to handle context
...
// Update InputDataProvider mock
jest.mock("@/components/saas/inputDataProviders", () => {
  const actual = jest.requireActual("@/components/saas/inputDataProviders");
...
// Mock SaaS components with specific requirements
...
// Add proper ConsoleDisplay mock
...
// Add proper StartTaskButton mock
...
// ...existing other component mocks...
...
describe("SaasTdsSuperUniqChangeOwn Page", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
