...
import SaasPage from "@/app/saas/tds/lld/midspan_auto_calc/page";
...
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/lld/midspan_auto_calc",
}));
...
describe("SaasTdsLldMidspanCalc Page", () => {
  ...
  describe("Permission and Components", () => {
    ...
    it("renders DocLinkButton with correct props", async () => {
      ...
      expect(docLink).toHaveAttribute("data-slug", "midspan-calculator");
    });
