...
import SaasPage from "@/app/saas/tds/arcgis/arcgis_api_snapshots_db621/page";

// Mock next/navigation
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/arcgis/arcgis_api_snapshots_db621",
}));
...
describe("SaasTdsArcgisSnapshots Page", () => {
