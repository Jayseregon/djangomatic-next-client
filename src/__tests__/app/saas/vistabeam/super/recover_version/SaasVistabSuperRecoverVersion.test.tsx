...
import SaasPage from "@/app/saas/vistabeam/super/recover_version/page";

// Mock next/navigation
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/vistabeam/super/recover_version",
}));

// Create mock context value before using it in mocks
...
// Mock inputDataProviders with context
...
describe("SaasVistabeamSuperRecoverVersion Page", () => {
