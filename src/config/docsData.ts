...
export const docsData = {
  ...
  comcast_docs: [
    ...
    {
      label: "Comcast Basemap Design Workflow",
      href: "/docs/comcast/comcast-basemap-design-workflow",
      is_qgis_doc: false,
    },
    // temp doc placeholder, qgis doc: FALSE
    {
    ...
    {
      label: "Comcast Doc Placeholder",
      href: "/docs/comcast/comcast-qgis-placeholder",
      is_qgis_doc: true,
    },
  ],
  admin_docs: [
    ...
    // temp doc placeholder, qgis doc: TRUE
    {
      ...
      href: "/docs/admin/admin-qgis-placeholder",
      is_qgis_doc: true,
    },
  ],
};
