...
// Mock auth before any component imports
jest.mock(
  "../../../../../../../auth",
  () => ({
    auth: jest.fn(),
...
import SaasPage from "@/app/saas/tds/override/spkv_override_hld_db/page";
...
jest.mock("next/navigation", () => ({
  usePathname: () => "/saas/tds/override/spkv_override_hld_db",
}));
...
describe("SaasTdsOverrideHldDb Page", () => {
  ...
  describe("Permission and Components", () => {
    ...
    it("passes correct client prop to components", async () => {
      const mockSession = {
        user: {
          email: "test@example.com",
        },
